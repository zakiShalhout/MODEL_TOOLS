...
###########################################################################
# given an input_dataFrame_, a traget_ for modeling, a testing_fraction, a random_state
...
def get_prepped_data(input_dataFrame_, target_, index_, testing_fraction, random_state):
    # target
    y_ = input_dataFrame_[target_]
